...
public final class APrioriteSuivanteExpr extends PExpr
{
    private PExpr2 _expr2_;

    public APrioriteSuivanteExpr()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APrioriteSuivanteExpr(
    ...
    {
        ((Analysis) sw).caseAPrioriteSuivanteExpr(this);
    }
